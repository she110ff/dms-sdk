...
describe("MultiUri Class", () => {
    it("Should get http and ipfs urls", () => {
        const uris = ["ipfs://QmSH4tFQd6zqPW9b8ryvtrnbhr9HATyetmWxtGgWUJ33ik", "https://example.com"];
    ...
    it("Should get multiple http urls", () => {
        const uris = ["http://notsecure.com", "https://other.io", "https://example.com"];
        const multiuri = new MultiUri(uris.join(","));
    ...
    it("Should get an ipfs uri with path", () => {
        const uri = "ipfs://QmSH4tFQd6zqPW9b8ryvtrnbhr9HATyetmWxtGgWUJ33ik/some/path";
...
describe("IPFS metadata origin", () => {
    ...
    it("Should fail to recognize a non-IPFS origin", () => {
        ...
        expect(() => resolveIpfsCid("ipfs://hello/abc")).toThrow(new InvalidCidError());
    });
});
