...
import { ContextPluginParams, ContextPluginState, ContextState } from "./interfaces/context";
// State
const defaultState: ContextPluginState = {};

export class ContextPlugin extends Context {
    protected state: ContextState & ContextPluginState = Object.assign({}, Context.getDefault(), defaultState);
